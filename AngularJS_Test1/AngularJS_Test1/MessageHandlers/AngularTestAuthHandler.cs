...
using System.Web;
using AngularJS_Test1.Extensions;
using AngularJS_Test1.Models;

namespace AngularJS_Test1.MessageHandlers
{
    public class AngularTestAuthHandler : DelegatingHandler,IDisposable
    {
